 ...
 * If it is the last list from booli api the function will print hte whole list to a csv file with the printResults function
 *
...
function setupAptObject(aptIn){
  var apt = {
      ...
      apt.address = aptIn.location.address['streetAddress'];
      apt.subArea = subArea;
      apt.area = bigArea;
      ...
      apt.areaTags = aptIn.location.namedAreas;
